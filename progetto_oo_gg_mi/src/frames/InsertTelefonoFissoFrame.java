...
public class InsertTelefonoFissoFrame extends JFrame implements ActionListener {
	private ControlTelFisso ControlT;
	...
	public InsertTelefonoFissoFrame(JFrame back, Point p, Contatto contatto){
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == backButton) {
			...
			this.dispose();
				...
				int CodN_Fisso= rand.nextInt(10000);
				ControlT=new ControlTelFisso();
				ControlT.InsertTelFisso(CodN_Fisso,insTxtNumeroTelefono.getText(),contatto.GetCod_Contatto(),this.contatto);
